...
for frequency, locations in antennae.items():
    for this_location in locations:
        ...
        for other_location in locations:
            ...
            antinode_location = other_location
            while is_location_valid(max_col, max_row, antinode_location):
                antinodes.add(antinode_location)
                antinode_location = (antinode_location[0] + col_diff, antinode_location[1] + row_diff)
